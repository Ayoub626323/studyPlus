        ...
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
            ...
            <div className="mt-6 grid grid-cols-2 gap-x-5 lg:mt-10">
              <div className="py-5">
                ...
                <p className="mt-3 text-sm text-gray-900">
                  <span className="font-bold">4.6</span> /5 - sur 12k avis
                </p>
                <div className="mt-5">
                  <svg
                    className="h-auto w-16 text-gray-900"
                    width="80"
                    height="27"
                    viewBox="0 0 80 27"
                    fill="none"
              ...
              <div className="py-5">
                ...
                <p className="mt-3 text-sm text-gray-900">
                  <span className="font-bold">4.8</span> /5 - sur 5k avis
                </p>
                <div className="mt-5">
                  <svg
                    className="h-auto w-16 text-gray-900"
          ...
          <div className="relative ms-4">
            <Image
              ...
              src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=700&h=800&q=80"
              alt="Étudiants en cours - PrépaPlus"
              width={700}
              height={800}
            />
            <div
