    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
        <div className="mx-auto mb-8 max-w-screen-sm text-center lg:mb-16">
          ...
          <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400 lg:mb-16">
        ...
        <div className="mb-6 grid gap-8 md:grid-cols-2 lg:mb-16">
          {PROFESSEURS.map((prof) => (
            <div
              key={prof.name}
              className="flex flex-col items-center rounded-lg bg-gray-50 shadow dark:bg-gray-800 dark:border dark:border-gray-700 sm:flex-row"
            >
              <a href="#" className="block w-full shrink-0 sm:w-48">
                <div className="relative aspect-square w-full overflow-hidden rounded-lg sm:rounded-none sm:rounded-l-lg">
                  <Image
                    src={prof.img}
                    alt={prof.name}
                    fill
              ...
              <div className="flex-1 p-5">
                ...
                <span className="text-gray-500 dark:text-gray-400">{prof.role}</span>
